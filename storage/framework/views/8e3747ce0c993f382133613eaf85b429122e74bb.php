...
<div class="notification" id="nfnav">
  <div class="title-nf">
      ...
      <input type="hidden" id="orgId" value="<?php echo e(Auth::user()->org_id); ?>">
    <ul class="nav nav-tabs" role="tablist">
      <li role="presentation">
        <a href="#message-clients" aria-controls="profile" role="tab" data-toggle="tab">
          <?php echo app('translator')->getFromJson('strings.customers_messages'); ?></a>
      </li>
  ...
  <div class="nf-content">
    <div class="tab-content">
      <div role="tabpanel" class="tab-pane" id="message-clients">
        ...
        <div class="time-d">
          <p class="time-date-nf datenf-2"> <?php echo e(date('h:i')); ?> </p>
          <p class="time-date-nf datenf-1"> <?php echo e(date('Y-m-d')); ?> </p>
        </div>
        <div class="trach">
        ...
        <p class="all-nf-s"> <?php echo e(__('strings.all_nf')); ?> </p>
        <!-- messages -->
        <div class="messagess" id="messagesSearch">
          ...
          ,"created_at"
            ...
            ?>
            <?php if(count($loginHistoryHidden) > 0): ?>
            <?php $__currentLoopData = $loginHistoryHidden; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            ...
            <a type="button" class="NotifyBtnClass" data-toggle="modal" data-target="#modelnawaf"><div class="item-messages" id="afterSee">
              <h3>
                <?php echo e(app()->getLocale() == 'ar' ? "تسجيل دخول" : "Login"); ?>

                <p id="iconseeDone"> <i class="fas fa-check"></i> </p>
                <p class="time-messages"> <i class="fas fa-clock"></i> <?php echo e($value->created_at); ?></p>
              </h3>
              
              <?php if($userlogin): ?>
              <p class="desk-messages"><?php echo e(app()->getLocale() == 'ar' ? " المستخدم $userlogin->name  سجل دخول " : "$userlogin->name_en Logged in "); ?></p>
              <?php endif; ?>
            </div>
            </a>
            <?php endif; ?>
            ...
            <a type="button" class="NotifyBtnClass" data-toggle="modal" data-target="#modelnawaf"><div class="item-messages" id="afterSee">
              <h3>
                <?php echo e(app()->getLocale() == 'ar' ? "تسجيل خروج" : "Logout"); ?>
              ...
              <?php if($userlogout): ?>
              <p class="desk-messages"><?php echo e(app()->getLocale() == 'ar' ? " المستخدم $userlogout->name سجل خروج " : "$userlogout->name_en Logged out "); ?></p>
              <?php endif; ?>
            </div>
            </a>
            <?php endif; ?>
          ...
          <?php endif; ?>
            ...
            <a type="button" class="NotifyBtnClass" data-toggle="modal" data-target="#modelnawaf"><div class="item-messages" id="afterSee">
              <h3>
                <?php echo e(app()->getLocale() == 'ar' ? "حجز جديد" : "New reservation"); ?>

                <p id="iconseeDone"> <i class="fas fa-check"></i> </p>
                <p class="time-messages"> <i class="fas fa-clock"></i> <?php echo e($value->created_at); ?></p>
              </h3>
              
              <p class="desk-messages"><?php echo e(app()->getLocale() == 'ar' ?   "تم اضافة حجز جديد للعميل $cust->name" : "New reservation added for $cust->name_en"); ?></p>
            </div>
            </a>
            <?php endif; ?>
            <?php endif; ?>
            <?php if($value->status == Auth::user()->id): ?>
            <?php
            ...
            <a type="button" class="NotifyBtnClass" data-toggle="modal" data-target="#modelnawaf"><div class="item-messages" id="afterSee">
              <h3>
                <?php echo e(app()->getLocale() == 'ar' ? "رسالة جديدة" : "New message"); ?>
              ...
              <?php if($userMsg): ?>
              <p class="desk-messages"><?php echo e(app()->getLocale() == 'ar' ?   "لديك رسالة جديدة من  $userMsg->name"  : "You have a new message from $userMsg->name_en"); ?></p>
              <?php endif; ?>
            </div>
            </a>
            <?php endif; ?>
            ...
            <a type="button" class="NotifyBtnClass" data-toggle="modal" data-target="#modelnawaf"><div class="item-messages" id="afterSee">
              ...
              <p class="desk-messages"><?php echo e(app()->getLocale() == 'ar' ?   "لديك رسالة عميل جديدة من  $value->user_id"  : "You have a new front message from $value->user_id"); ?></p>
          
            </div>
            </a>
           <?php endif; ?>
            <?php endif; ?>
            <?php if($value->status == 'offer'): ?>
            <?php
            ...
            <a type="button" class="NotifyBtnClass" data-toggle="modal" data-target="#modelnawaf"><div class="item-messages" id="afterSee">
              <h3>
                <?php echo e(app()->getLocale() == 'ar' ? "انتهاء عرض" : "Offer ended"); ?>

                <p id="iconseeDone"> <i class="fas fa-check"></i> </p>
                <p class="time-messages"> <i class="fas fa-clock"></i> <?php echo e($value->created_at); ?></p>
              </h3>
              
              <p class="desk-messages"><?php echo e(app()->getLocale() == 'ar' ?   "$value->user_id"  : "$value->org_id"); ?></p>
            </div>
            </a>
            <?php endif; ?>
            <?php endif; ?>
            <?php if($value->status == 'transaction'): ?>
            <?php
            ...
            <a type="button" class="NotifyBtnClass" data-toggle="modal" data-target="#modelnawaf"><div class="item-messages" id="afterSee">
              <h3>
                <?php echo e(app()->getLocale() == 'ar' ? "حد الطلب" : "transaction"); ?>
        ...
        <div class="messages" id="hidemessage">
          ...
          ?>
          <?php if($allNotifyACtivity < $allNotifications): ?>
          <?php if(count($loginHistory) > 0): ?>


          <?php $__currentLoopData = $loginHistory; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
          ...
          <?php if(Auth::user()->id != $value->user_id ): ?>
            <?php if($value->status == 'login'): ?>
              ...
              <a type="button" class="NotifyBtnClass" data-toggle="modal" data-target="#modelnawaf"><div class="item-messages" id="afterSee">
                <h3>
                  <button type="button" class="notifySeen" data-id="<?php echo e($value->id); ?>" data-type="login" name="button">X</button>
                  <?php echo e(app()->getLocale() == 'ar' ? "تسجيل دخول" : "Login"); ?>
          ...
          <?php if($value->status == 'logout'): ?>
            ...
            <a type="button" class="NotifyBtnClass" data-toggle="modal" data-target="#modelnawaf"><div class="item-messages" id="afterSee">
              <h3>
                <button type="button" class="notifySeen" data-id="<?php echo e($value->id); ?>" data-type="logout" name="button">X</button>
        ...
        <?php endif; ?>
          ...
          <a type="button" class="NotifyBtnClass" data-toggle="modal" data-target="#modelnawaf"><div class="item-messages" id="afterSee">
            <h3>
              <button type="button" class="notifySeen" data-id="<?php echo e($value->id); ?>" data-type="reservation" name="button">X</button>
            ...
            <p class="desk-messages"><?php echo e(app()->getLocale() == 'ar' ?   "تمت اضافة حجز جديد للعميل $cust->name" : "New reservation added for $cust->name_en"); ?></p>
          </div>
          </a>
          <?php endif; ?>
          <?php endif; ?>
          ...
          <a type="button" class="NotifyBtnClass" data-toggle="modal" data-target="#modelnawaf"><div class="item-messages" id="afterSee">
            <h3>
              <button type="button" class="notifySeen" data-id="<?php echo e($value->id); ?>" data-type="message" name="button">X</button>
          ...
          <?php endif; ?>
            ...
            <a type="button" class="NotifyBtnClass" data-toggle="modal" data-target="#modelnawaf"><div class="item-messages" id="afterSee">
              <h3>
                  <button type="button" class="notifySeen" data-id="<?php echo e($value->id); ?>" data-type="front_message" name="button">X</button>
                <?php echo e(app()->getLocale() == 'ar' ? "رسالة جديدة" : "New message"); ?>
          ...
          <a type="button" class="NotifyBtnClass" data-toggle="modal" data-target="#modelnawaf"><div class="item-messages" id="afterSee">
            <h3>
              <button type="button" class="notifySeen" data-id="<?php echo e($value->id); ?>" data-type="offer" name="button">X</button>
          ...
          <a type="button" class="NotifyBtnClass" data-toggle="modal" data-target="#modelnawaf"><div class="item-messages" id="afterSee">
            <h3>
              <button type="button" class="notifySeen" data-id="<?php echo e($value->id); ?>" data-type="transaction" name="button">X</button>
        ...
        <?php elseif($allNotifyACtivity == 0 && $allNotifications == 0): ?>
        <p class="pforNF">لا توجد إشعارات</p>
        <?php elseif($allNotifications == 0): ?>
        <p class="pforNF">لا توجد إشعارات</p>
        <?php else: ?>
        <p class="pforNF">لا توجد إشعارات</p>
        <?php endif; ?>
...
$(document).ready(function() {
  $("#nfnav").on("click", ".notifySeen", function() {
    ...
    var url = "<?php echo e(Route('editNotify')); ?>";
    $.ajax({
      headers: {
...
<script>
  ...
  function openMessage(id) {
    var user, user2 = '';
    $.get("<?php echo e(url('admin/notification/user_message/')); ?>/" + id, function(data) {
      $('.userCH').remove();
      $('.meCH').remove();
...
<script type="text/javascript">
  ...
  /* Subscribe to the channel we specified in our Laravel Event */
    ...
    let audio = new Audio("<?php echo e(asset('sounds/nf_sound.mp3')); ?>");
  ...
  channel.bind('App\\Events\\Notifications', function(data) {
    ...
    if (data.user['id'] != <?php echo e(Auth::user()->id); ?> && data.notify['org_id'] == <?php echo e(Auth::user()->org_id); ?> && data.type == 'login') {
    ...
    if (data.user['id'] != <?php echo e(Auth::user()->id); ?> && data.notify['org_id'] == "<?php echo e(Auth::user()->org_id); ?>" && data.type == 'logout') {
         $('.badge').css('display','block');
        audio.play();
    ...
    if (data.user['org_id']  == <?php echo e(Auth::user()->org_id); ?> && data.type == 'reservations') {
         $('.badge').css('display','block');
        audio.play();
    ...
    if (data.notify['to_id'] == <?php echo e(Auth::user()->id); ?> && data.user['org_id'] == "<?php echo e(Auth::user()->org_id); ?>" && data.type == 'newmsg') {
         $('.badge').css('display','block');
        audio.play();
      if ("<?php echo e(app()->getLocale()); ?>" == 'ar') {
        var newNotificationHtml = `
    ...
    if (data.user == <?php echo e(Auth::user()->org_id); ?> && data.type == 'offer') {
         $('.badge').css('display','block');
        audio.play();
      if ("<?php echo e(app()->getLocale()); ?>" == 'ar') {
        var newNotificationHtml = `
    ...
    /* check if type equal offer Ended and org_id equal user org_id; */
    if (data.user == <?php echo e(Auth::user()->org_id); ?> && data.type == 'transaction') {
         $('.badge').css('display','block');
        audio.play();
      if ("<?php echo e(app()->getLocale()); ?>" == 'ar') {
        var newNotificationHtml = `
