...
<body>
    ...
    <div class="email">
        <div class="top_hi">
            <h2> <span><?php echo e(app()->getLocale()=='ar'? $data['org']->name : $data['org']->name_en); ?></span> لإدارة الأعمال </h2>

        </div>

        <div class="contant_mail">
            <h6><?php echo app('translator')->getFromJson('strings.welcome_to'); ?> <span><?php echo e($data['customer_name']); ?></span> </h6>
						<p><?php echo e(app()->getLocale()=='ar'? $data['org']->about_us : $data['org']->aboutus_en); ?></p>
        </div>
        ...
        <div class="need-help">
            <h3>هل تحتاج لمساعدة؟</h3>
            <p> إذا كان لديك إستسفار أو وجاهتك مشكلة ما أثناء إستخدام برنامج فايل رول راسلنا علي
                <a href="mailto:<?php echo e($data['org']->email); ?>"><?php echo e($data['org']->email); ?></a>
        ...
        <div class="footer_mail">
            <p>
                تم إرسال هذه الرسالة إلي
                <a> <?php echo e($data['org']->email_crm); ?> </a>

                <br>
                إذا كنت ﻻ ترغب في إستﻻم المزيد من الرسائل علي هذا البريد الإلكتروني يمكنك
                <a href="#">إلغاء الإشتراك</a>
            </p>
