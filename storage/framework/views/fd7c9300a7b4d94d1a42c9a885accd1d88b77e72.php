	...
	<meta name="keywords" content="filerole, programs, startup" />
	 ...
	 <meta name="lang" content="<?php echo e(app()->getLocale()); ?>">
        ...
        <link rel="stylesheet" href="<?php echo e(url('/')); ?>/front/css/bootstrap-rtl.min.css">
				...
				<link rel="stylesheet" href="<?php echo e(url('/')); ?>/front/css/default-assets/classy-nav.css">
        <?php else: ?>
...
?>
				...
				<div class="container">
						...
						<div class="main-header">
								...
								<div class="top-header">
														...
														<ul class="nav">
															...
															<li id="search" class="header-search">
																...
																<li class="dropdown">
																	<a href="#" class="dropdown-toggle" data-toggle="dropdown">
																			<span class="fas fa-globe xs-icon"></span>
																			<?php echo app('translator')->getFromJson('strings.currency'); ?>
																	</a>
																	<ul class="dropdown-menu">
																		<?php
                            		  ...
                            		  <li ><a href="#"><?php echo e(app()->getLocale() =='ar' ? $currency->name : $currency->name_en); ?></a></li>
      ...
      <ul class="dropdown-menu">
             ...
             <li ><a href="<?php echo e(url('/customerdashboard')); ?>">  <?php echo app('translator')->getFromJson('strings.inovices_resrvition'); ?> </a></li>
...
data-toggle="modal" data-target="#cart">Cart (<span class="total-count"></span>)</button>-->
             ...
             <ul class="dropdown-menu">
                 ...
                 <div class="buttons-cart">
                         <a href="<?php echo e(url('/cart')); ?>" class="view_cart"> View Cart </a>
