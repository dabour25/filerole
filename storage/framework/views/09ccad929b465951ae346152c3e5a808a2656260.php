<?php $__env->startSection('content'); ?>
    ...
    <div id="main-wrapper">
        <div class="row">
            ...
            <div class="col-md-6 form-group<?php echo e($errors->has('name') ? ' has-error' : ''); ?>"> <strong class="text-danger">*</strong>
            ...
            <div class="col-md-6 form-group<?php echo e($errors->has('name_en') ? ' has-error' : ''); ?>"> <strong class="text-danger">*</strong>
                <label class="control-label" for="name_en"><?php echo e(__('strings.English_name')); ?></label>
                <input type="text" class="form-control" name="name_en" value="<?php echo e($role->name_en); ?>">
            ...
            <div class="col-md-12 form-group">
                <div class="check_all">
                    ...
                    <li class="dropdown mega-dropdown">
                        <input type="checkbox" onclick="checkallin(<?php echo e($par->id); ?>)" class="checkhour" id="par<?php echo e($par->id); ?>" name="acs[]" value="<?php echo e($par->id); ?>" <?php echo e(App\functions_role::where('role_id' ,$role->id)->where('org_id',Auth::user()->org_id)->where('functions_id',$par->function_id)->count()>0 ? 'checked'  : ''); ?>>
                        ...
                        <ul class="dropdown-menu dropdown-menuNew mega-dropdown-menu">
                            ...
                            <li class="check_menu">
                                ...
                                <input type="checkbox" name="acs[]" type="checkbox" value="<?php echo e($auth->id); ?>" class="checkhour checkchild<?php echo e($par->id); ?>" onclick="checktiny(<?php echo e($par->id); ?>,<?php echo e($auth->id); ?>)" <?php echo e(App\functions_role::where('role_id' ,$role->id)->where('org_id',Auth::user()->org_id)->where('functions_id',$auth->function_id)->count()>0 ? 'checked'  : ''); ?> id="child<?php echo e($auth->id); ?>">
                                ...
                                <?php $__currentLoopData = $auth->childs()->where('org_id',Auth::user()->org_id)->orderby('porder')->get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $child): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    ...
                                    <input type="checkbox" name="acs[]" type="checkbox" value="<?php echo e($child->id); ?>" class="checkhour checkchild<?php echo e($par->id); ?> tinycheck<?php echo e($auth->id); ?>" id="tiny<?php echo e($child->id); ?>" onclick="checkselected(<?php echo e($par->id); ?>,<?php echo e($auth->id); ?>)" <?php echo e(App\functions_role::where('role_id' ,$role->id)->where('org_id',Auth::user()->org_id)->where('functions_id',$child->function_id)->count()>0 ? 'checked'  : ''); ?>> 
                                    <span class="checkmark"></span>
                                    </label>
            ...
            <div class="col-md-12 form-group<?php echo e($errors->has('description') ? ' has-error' : ''); ?>">
                ...
                <textarea type="text" class="form-control textall"
                          name="description"><?php echo e($role->description); ?></textarea>
            ...
            <div class="col-md-12 form-group text-right">
                <button type="submit" class="btn btn-primary btn-lg"> <i class="fas fa-save"></i> <?php echo e(__('strings.Save')); ?></button>
            </div>
        </form>
    </div>
</div>
...
<?php echo $__env->make('layouts.admin', ['title' => __('strings.Role_edit') ], array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>