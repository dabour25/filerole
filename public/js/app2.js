...
$(document).ready(function(){
    ...
    // if ($(div).hasClass('.pages-head')) {

    // } else {
    //     $('body').append('<div class="pages-head"><div class="container"></div></div>')
    // }

    // var div = $('.submit-btn').clone();
    // var divP = $('.panel-body:last').clone();
    // $('.submit-btn').remove();
    // $('.panel-body:last').remove();

    // $('.pages-head').addClass('fixed-div').append(div);
    // $('.pages-head .container').append(divP);
