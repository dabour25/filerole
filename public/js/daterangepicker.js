...
(function ($) {
	...
	var datepickerOptions = {
		...
		if(rangeInput.size() == 2){
			inputDateAtemp = moment( rangeInput.eq(0).val(),settings.momentConverter).toDate();
			inputDateBtemp = moment( rangeInput.eq(1).val(),settings.momentConverter).toDate();
			if(inputDateAtemp == null){inputDateAtemp = inputDateBtemp;}
			if(inputDateBtemp == null){inputDateBtemp = inputDateAtemp;}
		}
		else {
            inputDateAtemp = moment(rangeInput.val().split(options.rangeSplitter)[0],settings.momentConverter);
            inputDateBtemp = moment(rangeInput.val().split(options.rangeSplitter)[1],settings.momentConverter);
			if(!inputDateBtemp.isValid()){inputDateBtemp = inputDateAtemp;} //if one date, set both
		}
		if(inputDateAtemp.isValid()){inputDateA = inputDateAtemp.toDate();}
		if(inputDateBtemp.isValid()){inputDateB = inputDateBtemp.toDate();}
