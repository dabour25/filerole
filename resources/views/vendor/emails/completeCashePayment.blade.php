...
<body>
    ...
    <div class="email">
        <div class="top_hi">
            <h2> <span>{{app()->getLocale()=='ar'?$data['org_name']->name:$data['org_name']->name_en}}</span>
                {{__('strings.bussiness_mange')}}
            </h2>
        </div>
        <div class="contant_mail">
            <h6> {{__('strings.welcome')}} <span>{{$data['customer_name']}}</span>, </h6>
        </div>

        <hr>
        <div class="contant_mail">
            <p>{{__('strings.welcome')}}<span>{{$data['customer_name']}} </span> </p>
            <p>{{__('strings.regardingto')}} {{__('strings.invoice_no')}} <span> {{$data['invoice_no']}} </span> {{__('strings.cash_payment_message')}}: {{$data['total_amount']}}</p>
            {{__('strings.will contact you')}}
            <p> {{__('strings.thanks_shopping')}} <span>{{app()->getLocale()=='ar'?$data['org_name']->name:$data['org_name']->name_en}}</span> </p>
        </div>
        ...
        <div class="footer_mail">
            <p>
              ...
              {{__('strings.email_cancel_message')}}
                <a href="http://master.filerolesys.com/unsubscripe?{{$data['email']}}">{{'strings.unsubscripe'}}</a>
            </p>
            <ul>
