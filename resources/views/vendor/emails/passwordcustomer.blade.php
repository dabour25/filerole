                                                       ...
                                                       style="mso-line-height-rule: exactly;
                                                        ...
                                                        <img align="none" alt="" height="auto"
                                                             ...
                                                             style="-ms-interpolation-mode: bicubic; border: 0; outline: none;
                                                                         text-decoration: none; height: auto; max-width: 50%; height: auto; margin: 0px;" width="auto" />
                                                    </a>
                                                </td>
                                            </tr>
                                            </tbody>
                                                        ...
                                                        <tr>
                                                            <td align="center" class="mcnButtonContent"
                                                                ...
                                                                style="mso-line-height-rule:
                                                                  ...
                                                                  <a class="mcnButton " href="{{ url($data['link'].'/'.$data['token']) }}"
                                                                   style="mso-line-height-rule: exactly;
                                            ...
                                            <tr>
                                                <td
                                                    ...
                                                    <h3
                                                        ...
                                                        is{{ app()->getLocale()=='ar'? $data['org']->name : $data['org']->name_en  }} ?</h3>
                                                    ...
                                                    <p
                                                            ...
                                                            text-align: left; text-align: left; font-size: 14px; '>{{ app()->getLocale()=='ar'? $data['org']->about_us : $data['org']->aboutus_en  }}
                                                    </p>
                                                    ...
                                                    <div style="text-align: center;">Made with
                                                        ...
                                                        <a href=""
                                                           style="mso-line-height-rule: exactly;
                                                                    ...
                                                                    font-weight: normal; text-decoration: none; color:#000;" target="_blank"
                                                           title="file Role">File Role Master
                                                            Project</a> in Giza <i class="fas fa-map-marker" style="font-size:20px"></i></div>
                                                </td>
                                            </tr>
                                            <tbody></tbody>
                                            </tbody>
                                            ...
                                            <tr>
                                                ...
                                                -webkit-text-size-adjust: 100%">
                                                    <a href="https://twitter.com"
                                                       style="mso-line-height-rule: exactly; -ms-text-size-adjust: 100%;
                                                -webkit-text-size-adjust: 100%; color:#401e29; font-weight: normal; text-decoration: none" target="_blank">
