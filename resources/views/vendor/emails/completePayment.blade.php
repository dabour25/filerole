...
<body>
    ...
    <div class="email">
        ...
        <div class="contant_mail">
            ...
            <p>{{__('strings.regardingto')}} {{__('strings.invoice_no')}} <span> {{$data['invoice_no']}} </span> {{__('strings.collect_money')}}: {{$data['total_amount']}}</p>
        ...
        <div class="footer_mail">
            <p>
              {{__('strings.email_sendto')}}
                ...
                <a href="http://master.filerolesys.com/unsubscripe?{{$data['email']}}">{{__('strings.unsubscripe')}}</a>
            </p>
            <ul>
