<!doctype html>
<html dir="rtl" xmlns="http://www.w3.org/1999/xhtml" xmlns:v="urn:schemas-microsoft-com:vml"
...
<center>
                ...
                <table border="0" cellpadding="0" cellspacing="0" class="templateContainer"
                                        ...
                                        <table align="left" border="0" cellpadding="0" cellspacing="0"
                                            ...
                                            <tr>
                                                <td class="mcnTextContent"
                                                    style='mso-line-height-rule: exactly; background-color: #fff;
                                                           -ms-text-size-adjust: 100%; -webkit-text-size-adjust: 100%; word-break: break-word;
                                                          color: #fff; font-family: "Asap", Helvetica, sans-serif; font-size: 12px;
                                                          line-height: 150%; text-align: left; padding-top:9px; padding-right: 18px;
                                                          padding-bottom: 9px; padding-left: 18px;text-align: center;'
                                                    valign="top">
                                                    <a href="#"
                                                       style="mso-line-height-rule: exactly;
                                                       ...
                                                       target="_blank">
                                                        <img align="none" alt="" height="auto"
                                                             src="https://master.filerolesys.com/favicon.png"
                                                             style="-ms-interpolation-mode: bicubic; border: 0; outline: none;
                                                                         text-decoration: none; height: auto; max-width: 50%; height: auto; margin: 0px;"
                                                             width="auto"/>
                                                    </a>
                                                </td>
                                            </tr>
                                                ...
                                                <td class="mcnTextContent"
                                                    ...
                                                    <h1 class="null"
                                                        style='color: #2a2a2a; font-family: "Asap", Helvetica,
                                                                    ...
                                                                    padding: 0'><span style="text-transform:uppercase">بيانات دخولك</span>
                                                    </h1>
                                                    ...
                                                    <h2 class="null"
                                                        style='color: #2a2a2a; font-family: "Asap", Helvetica,
                                                                ...
                                                                padding: 0'><span style="text-transform:uppercase">لنظام فايل رول لإدارة الأعمال</span>
                                                    </h2>
                                ...
                                <tr>
                                    ...
                                    100%; min-width:100%;" width="100%">
                                        ...
                                        padding-bottom: 9px; padding-left: 18px;' valign="top">
                                                    ...
                                                    <br>
                                                    الرجاء استخدام الرابط التالى للدخول لحسابك
                                                        ...
                                                        <tr>
                                                            <td align="center" class="mcnButtonContent"
                                                                ...
                                                                <a class="mcnButton " href="{{ $url }}"
                                                                   style="mso-line-height-rule: exactly;
                                                                            -ms-text-size-adjust: 100%; -webkit-text-size-adjust: 100%; display: block; color: green;
                                                                   ...
                                                                   target="_blank" title="">رابط الدخول</a>
                                                            </td>
                                                        </tr>
                                                        </tbody>
                                                    </table>
                    ...
                    <tr>
                        <td id="templateFooter"
                            style="mso-line-height-rule: exactly;
                                     -ms-text-size-adjust: 100%; -webkit-text-size-adjust: 100%; background-color: #e6e6e6;
 ...
 -ms-text-size-adjust: 100%; -webkit-text-size-adjust: 100%; min-width:100%;" width="100%">
                                ...
                                <tr>
                                    <td class="mcnTextBlockInner"
                                        ...
                                        <table align="center" bgcolor="#F7F7FF" border="0" cellpadding="32"
                                            ...
                                            <tr>
                                                <td
                                                    ...
                                                    <h3
                                                            style='color: #2a2a2a; font-family: "Asap", Helvetica, sans-serif;
                                                    ...
                                                    <p
                                                            style='margin: 10px 0; padding: 0; mso-line-height-rule: exactly;
                                                            -ms-text-size-adjust: 100%; -webkit-text-size-adjust: 100%; color: #2a2a2a;
                                                            font-family: "Asap", Helvetica, sans-serif; font-size: 12px; line-height: 150%;
                                                            text-align: left; text-align: left; font-size: 14px; '>an
                                                        integrated cloud platform containing specialized programs for
                                                        each type of business activities. These programs include a POS
                                                        system, an accounting system, personnel, salaries, finance,
                                                        warehousing, marketing and all that the business requires to be
                                                        fully completed with ease, flexibility and efficiency. They
                                                        arranged ideas and priorities. And began working on paper for
                                                        six months until the completion of the visualization. And then
                                                        starting a year and a half ago by building the platform until it
                                                        is almost finished, and will soon celebrate the launch of their
                                                        first program, Saloon program to manage women's beauty salons.
                                                    </p>
                                                    <div style="padding-bottom: 18px;">
                                                        <a href="#"
                                                           ...
                                                           target="_blank" title="Learn more about Lingo">Learn More
                                                            ❯</a>
                                                    </div>
                                                </td>
                                            </tr>
                                        ...
                                        padding-bottom: 24px; padding-left: 18px; color: #000; font-family: 'Asap',
                                        Helvetica, sans-serif; font-size: 12px;" valign="top">
                                                    <div style="text-align: center;">Made with
                                                        <a href=""
                                                           style="mso-line-height-rule: exactly; -ms-text-size-adjust: 100%;
                                                                    -webkit-text-size-adjust: 100%; color: red; font-weight: normal; text-decoration:
                                                                    none" target="_blank">
                                                            <i class="fas fa-heart"></i>
                                                        </a>by
                                                        <a href="#"
                                                           style="mso-line-height-rule: exactly;
                                                                    -ms-text-size-adjust: 100%; -webkit-text-size-adjust: 100%; color: #000;
                                                                    font-weight: normal; text-decoration: none; color:#000;"
                                                           target="_blank"
                                                           title="file Role">Filerole</a> <i class="fas fa-map-marker"
                                ...
                                100%; -webkit-text-size-adjust: 100%; ">
                                            ...
                                            <tr>
                                                ...
                                                -webkit-text-size-adjust: 100%">
                                                    <a href="https://twitter.com"
                                                       style="mso-line-height-rule: exactly; -ms-text-size-adjust: 100%;
                                                -webkit-text-size-adjust: 100%; color:#401e29; font-weight: normal; text-decoration: none"
                                                       target="_blank">
                                            ...
                                            -webkit-text-size-adjust: 100%">
                                                    <a href=""
                                                       style="mso-line-height-rule: exactly; -ms-text-size-adjust: 100%;
                                                -webkit-text-size-adjust: 100%; color:#03a9f4; font-weight: normal; text-decoration:
                                                none" target="_blank">


                                                        <i class="fab fa-twitter-square" style="
                                                    font-size: 43px;
                                                "></i>
                                                    </a>
                                                </td>
 ...
 -webkit-text-size-adjust: 100%; color:#2196f3; font-weight: normal; text-decoration: none" target="_blank">

                                                        <i class="fab fa-facebook-square" style="font-size:43px"></i>
                                                    </a>
                                                </td>
                                            </tr>
                                            </tbody>
