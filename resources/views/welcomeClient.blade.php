...
<body class="thanks">
    ...
    <div class="welcome-you wow flipInX">
        ...
        <h3>{{__('strings.welcome_to')}}<span>{{app()->getLocale()=="ar"?$user->name:$user->name_en}}</span>
				</h3><p>{{__('strings.complete_registration_message')}}</p>
				<a class="sett-a" href="{{url('/admin/settings')}}">{{__('strings.account_settings')}}</a> </p>
        <a href="{{url('/admin/dashboard')}}" class="account-dash"> {{__('strings.account_control')}}</a>
        <a href="{{url('/admin/transactions/create')}}" class="make-dash"> {{__('strings.make_invoice')}}</a>
    </div>
