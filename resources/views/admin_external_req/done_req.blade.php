...
use Carbon\Carbon;
@endphp
@extends('layouts.admin', ['title' => __('strings.external_req_done')])
@section('styles')
      ...
      <div id="main-wrapper">
          <div class="row">
              <div class="col-md-12">
                        ...
                        <form action="{{ Route('search_cust_req') }}" id="serachExternalReqForm">
                            <div class="col-md-4 col-xs-12 form-group">
                                ...
                                <select class="form-control" name="type">
                                    <option style="display:none" value="d" {{ $oldData && $oldData['type'] == 'd'? 'selected' :'' }}></option>
                  ...
                  <div class="panel panel-white">
                      <div class="panel-heading clearfix">
                          <h4 class="panel-title">  {{ __('strings.external_req_done') }}</h4>
                      </div>
                      <div class="panel-body">
                          <table id="xtreme-table" class="table table-striped table-bordered" style="width:100%">
                                  <thead>
                                      <tr>
                                          ...
                                          <th>{{ __('strings.external_delivery_fees') }}</th>
                                          <th>{{ __('strings.external_req_total') }}</th>
                                          <th>{{ __('strings.external_req_res_status') }}</th>
                                          <th>{{ __('strings.external_req_responsible') }}</th>
                                      </tr>
                                  </thead>
                                  <tbody>
                                    ...
                                    <tr>
                                      ...
                                      <td>{{ Decimalplace(abs($doneReq->delivery_fees)) }}</td>
