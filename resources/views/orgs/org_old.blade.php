        ...
        <div class="row">
            ...
            <div class="col-md-9">
                <div class="panel panel-white">
                    ...
                    <div class="panel-body">
                        <div class="">
                            ...
                            <form method="post" action="{{ url('admin/orgs/update', $org->id) }}"
                                ...
                                <div class="col-md-6 form-group{{$errors->has('about_us') ? ' has-error' : ''}}"><strong
                                            class="text-danger">*</strong>
                                ...
                                <div class="col-md-6 form-group{{$errors->has('mobile2') ? ' has-error' : ''}}"><strong
                                            class="text-danger">*</strong>
                                ...
                                <div class="col-md-6 form-group{{$errors->has('mobile1') ? ' has-error' : ''}}"><strong
                                            class="text-danger">*</strong>
                   ...
                   <div class="col-md-6 form-group{{$errors->has('attendance_start_day') ? ' has-error' : ''}}" style="display:block;"><strong
                                            class="text-danger">*</strong>
								...
								@else
						<div class="col-md-6 form-group{{$errors->has('attendance_start_day') ? ' has-error' : ''}}" style="display:none;"><strong
                                            class="text-danger">*</strong>
                              ...
                              @endif
                                ...
                                <div class="col-md-6 form-group{{$errors->has('currency') ? ' has-error' : ''}}"><strong
                                            class="text-danger">*</strong>
                                    <label class="control-label" for="currency">@lang('strings.currency')</label>
                                    <select class="form-control" name="currency">
                                        <option value="0">@lang('strings.currency_choose')</option>
										@php 
                                ...
                                <div class="col-md-6 form-group{{$errors->has('twitter') ? ' has-error' : ''}}"><strong
                                            class="text-danger">*</strong>
                                ...
                                <div class="col-md-6 form-group{{$errors->has('facebook') ? ' has-error' : ''}}"><strong
                                            class="text-danger">*</strong>
                                ...
                                <div class="col-md-6 form-group{{$errors->has('instgram') ? ' has-error' : ''}}"><strong
                                            class="text-danger">*</strong>
