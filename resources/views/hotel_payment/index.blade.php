            ...
            <div class="col-md-12">
             ...
             @include('alerts.index')
                      ...
                      <div class="alert_new">
                          ...
                          <p>
                              @if (app()->getLocale() == 'ar')
            {{ DB::table('function_new')->where('id',260)->value('description') }}
            @else
            {{ DB::table('function_new')->where('id',260)->value('description_en') }}
            @endif
                          </p>
                      ...
                      <form method="get" action="{{url('admin/serach_hotel_pay_method')}}" enctype="multipart/form-data">
                        {{csrf_field()}}
                      <div class="col-lg-3 col-md-4 col-sm-6 m-b-sm">

                                            <select class="form-control js-select" name="hotel_name"  >
                                           <option value="0" >@lang('strings.All')</option>
                                            @foreach($propertys as $property)
                                            <option {{ app('request')->input('hotel_name') == $property->id ? 'selected' : ''}}  value="{{$property->id}}">{{ app()->getLocale() == 'ar' ? $property->name  : $property->name_en  }}</option>
                                                @endforeach
                                            </select>
                        </div>
                                ...
                                <table id="xtreme-table" class="display table" style="width: 100%; cellspacing: 0;">
                                    ...
                                    @if($value->default==1)
                                        <tr>
                                            ...
                                            <td>{{ $value->gateway }}</td>
                                            <td>
                              <a href="edit_hotel_pay_method/{{ $value->id }}" class="btn btn-primary btn-xs" data-toggle="tooltip" data-placement="bottom" title=""  data-original-title="{{ __('strings.edit') }} "> <i  class="fa fa-pencil"></i></a>
                              <a href="delete_hotel_pay_method/{{ $value->id }}" class="btn btn-danger btn-xs" data-toggle="tooltip" data-placement="bottom" title="" data-original-title="{{ __('strings.delete_btn') }}"> <i class="fa fa-trash-o"></i></a>
                                            </td>
                                          </tr>
                                        @endif
                                            @endforeach
