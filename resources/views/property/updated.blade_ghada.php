...
@section('content')
          ...
          <form method="post" action="{{url('admin/update_policy_details')}}" enctype="multipart/form-data">
              ...
              <div class="col-md-12 form-group{{$errors->has('details') ? ' has-error' : ''}}">
                                       ...
                                       <div class="col-md-12 form-group{{$errors->has('details_en') ? ' has-error' : ''}}">
                                                                    ...
                                                                    <input type="text"  name="details_en" id="details_en">
                                                                    @if ($errors->has('details'))
                                                                        <span class="help-block">
  ...
  <div class="modal-content">
      <div class="modal-body" style="overflow: hidden">
        <form method="post" action="{{url('admin/update_policy_details')}}" id="update_policy" enctype="multipart/form-data">
            ...
            <div class="col-md-12 form-group{{$errors->has('details') ? ' has-error' : ''}}">
                                         ...
                                         <input type="text"  name="details" id="details_information" >
                                         @if ($errors->has('details'))
                                             <span class="help-block">
                                                 <strong class="text-danger">{{ $errors->first('details') }}</strong>
                                             </span>
                                     ...
                                     <div class="col-md-12 form-group{{$errors->has('details_en') ? ' has-error' : ''}}">
                                                                  ...
                                                                  <input type="text"  name="details_en" id="details_en_information">
                                                                  @if ($errors->has('details'))
                                                                      <span class="help-block">
                                                                          <strong class="text-danger">{{ $errors->first('details_en') }}</strong>
                                                                      </span>
    ...
    <div id="main-wrapper">
          ...
          <div role="tabpanel">
              ...
              <div class="tab-content">
                  ...
                  <ul class="nav nav-pills" role="tablist">
                      <li role="presentation"  id="baic_tab" class="active"><a href="#tab-1" role="tab" data-toggle="tab"><i
        ...
        <div role="tabpanel"  class="tab-pane" id="tab-2" aria-labelledby="tab-2" >
            ...
            <div class="panel panel-white">
              ...
              <div class="col-md-12 form-group{{$errors->has('policy_type') ? ' has-error' : ''}}">
                <div class="form-group">
                <label class="control-label" for="currency_id">السياسات</label>
                  <div class="form-field">
                    <i class="icon icon-arrow-down3"></i>
              ...
              <button type="button" id="add_policy"  onclick="show_input_label_policy()"  class="btn btn-info btn-lg"><i class="fas fa-plus"></i></button>
              <div id="policy_name" style="display:none">
   ...
   <button  class="btn btn-primary btn-xs" id="modal_button{{$value->id}}" onclick="modal_show('{{$value->id}}')" data-type="{{$value->type}}" data-tab="tab-2"  data-id="{{$value->id}}" data-details="{{$value->details}}" data-details_en="{{$value->details_en}}" data-policy_type_id="{{$value->policy_type_id}}"   data-toggle="modal" data-target="#addclient" ><i  class="fa fa-pencil"></i></button>
                      ...
                      <h4 class="panel-title">{{ app()->getLocale()=='ar' ? $property->name : $property->name_en}}</h4>
                          ...
                          <form method="post" action="{{url('admin/policy/save')}}" enctype="multipart/form-data">
                           ...
                           <input type="hidden" name="tab" id="tab_information" value="tab-3">
                            @php
                             session()->put('informatin','tab-3' );
                             @endphp
                          <div class="col-md-12 form-group{{$errors->has('policy_type') ? ' has-error' : ''}}">
                            <div class="form-group">
                            <label class="control-label" for="currency_id">المعلومات</label>
                              <div class="form-field">
                                <i class="icon icon-arrow-down3"></i>
                                <select name="policy_type_id" id="policy_type2" class="form-control js-select">
                                  <option value=0>{{ __('strings.choose_policy') }}</option>
                                  @foreach($policys as $policy)
                                  @if($policy->type==2)
                                  <option value="{{$policy->id}}">{{ app()->getLocale()== 'ar' ? $policy->name : $policy->name_en}}</option>
                                  @endif
                          ...
                          <button type="button" id="add_information"  onclick="show_input_label_informatioml()"  class="btn btn-info btn-lg"><i class="fas fa-plus"></i></button>
                          <div id="information_name" style="display:none">
                          <div    class="col-md-6 form-group{{$errors->has('name') ? ' has-error' : ''}}">
                              <label class="control-label" for="name">{{ __('strings.Arabic_name') }}</label>
                              <input type="text" class="form-control" name="name" id="name" value="{{old('name')}}" >
                              @if ($errors->has('name'))
                          ...
                          <div class="table-responsive">
                            ...
                            <!-- <button type="button" class="btn btn-primary btn-lg NewBtn btnclient" onclick="show_data()" data-toggle="modal" data-id="{{$value->id}}" data-target="#addroomType"><i  class="fa fa-pencil"></i></button> -->
               <button  class="btn btn-primary btn-xs" id="modal_button{{$value1->id}}" onclick="modal_show('{{$value1->id}}')" data-tab="tab-3" data-id="{{$value1->id}}" data-details="{{$value1->details}}" data-details_en="{{$value1->details_en}}" data-policy_type_id="{{$value1->policy_type_id}}"  data-type="{{$value1->type}}"    data-toggle="modal" data-target="#addclient1" ><i  class="fa fa-pencil"></i></button>
    ...
    <script>
        ...
        function show_input_label_informatioml(){

        document.getElementById('information_name').style.display='block';
        document.getElementById('add_information').style.display='none';
        }
         function show_input_label_policy(){

        document.getElementById('policy_name').style.display='block';
        document.getElementById('add_policy').style.display='none';
