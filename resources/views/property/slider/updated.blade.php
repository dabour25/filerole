    ...
    <div id="main-wrapper">
        <div class="row">
            ...
            <div class="modal-body" style="overflow: hidden">
                ...
                <hr>
                <br>
                <form method="post" action="{{url('admin/property/slider/updated')}}" enctype="multipart/form-data">
                    {{csrf_field()}}
                    <div class="col-md-12 form-group{{$errors->has('type') ? ' has-error' : ''}}">
                        <div class="form-group">
                            <label class="control-label" for="type">{{ __('strings.slider_type') }}</label>
                        </div>
                    </div>
                    ...
                    @if(!empty($slider->photo))
                        <div class="col-md-3">
                            <img src="{{$slider->image ? asset($slider->photo->file): asset('images/profile-placeholder.png')}}" class="img-responsive">
                        </div>
                    @endif
                    ...
                    <div class="col-md-6 form-group{{$errors->has('rank') ? ' has-error' : ''}}"> <strong class="text-danger"></strong>
                        ...
                        <input type="number" class="form-control" name="rank" id="rank" value="{{old('rank')!==null?old('rank'):$slider->rank}}">
                        @if ($errors->has('rank'))
                            <span class="help-block">
