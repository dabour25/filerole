...
<div class="welcome-message" id="messageWelcome">
    <div class="container">
        <div class="message-in" id="itemMessage">
            <div class="logo-message"><img src="{{ asset('favicon.png') }}"></div>
            ...
            <div class="content-message">
                ...
                <a href="#" class="message-link">http://{{$owner_url.'/'.'admin/login'}}</a>
                <p>{{__('strings.save_link_for_access_1')}}</p>
            ...
            <div>
                ...
                <section>
                    <div class="row">
                        ...
                        <div class="col-md-4 col-xs-12">
                            <label>{{__('strings.address')}}<em>*</em></label>
                    ...
                    <div class="type-work">
                        ...
                        <div class="work-items row" id="selectable">
                            @foreach($activities as $activity)
                                ...
                                <div class="item-worr" id="activity{{$activity->id2}}">
                ...
                <h3> {{__('strings.Confirm_activity')}} </h3>
                <section>
...
<script>
    ...
    form.validate({
        ...
        rules: {
            ...
            messages:{
              "mobile": {
                  remote : "{{trans('admin.phone already used')}}",
    ...
    form.children("div").steps({
        ...
        finish: "{{__('strings.finish')}}",
        next: "{{__('strings.next')}}",
        previous: "{{__('strings.previous')}}",
        loading: "Loading ..."
    },
        onStepChanging: function (event, currentIndex, newIndex) {
            ...
            if (currentIndex === 0) {
              ...
              if(iti.isValidNumber() && form.valid()){
                return true;
              }
              else{
                return false;
    ...
    input.addEventListener('blur', function () {
        ...
        if (input.value.trim()) {
            if (iti.isValidNumber()) {
                ...
                $('#valid-msg').append('valid');
            } else {
                input.classList.add("error");
                var errorCode = iti.getValidationError();
                errorMsg.innerHTML = errorMap[errorCode];
                $('#valid-msg').empty();
                $('#error-msg').append(errorMap[errorCode]);
