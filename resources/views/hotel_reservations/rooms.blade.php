    ...
    <div id="main-wrapper">
        <div class="row">
            ...
            @endif
               ...
               <div class="card" style="height:124px;background-color: #92a8d1;">
   <div class="row" style="padding:20px; float:right;">
   <div class="col-sm-3" style="border-right:2px solid #ccc;text-align:center;">{{app()->getLocale() == 'ar'? $hotel_room->name :$hotel_room->name_en}}</div>
                              ...
                              <table id="xtreme-table{{$hotel->id}}" class="display table" style="width: 100%; cellspacing: 0;">
                                    ...
                                    @foreach($hotel_room->meal_plans as $meal_plan)
                                            <tr>
                                              ...
                                              <td>
                                                <select name="rooms_number[]"  data-id="{{$meal_plan->id}}" data-cat_sub_id="{{$meal_plan->catsub_id}}" data-price="{{$meal_plan->price}}" data-tax_id="{{$meal_plan->tax_id}}"  data-tax_val="{{$meal_plan->tax_val}}" data-total_rooms="{{$hotel_room->numbers}}">
                                                @php

                                                  for($i=0;$i<=$hotel_room->numbers;$i++){
