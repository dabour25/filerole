        ...
        <div class="row">
            ...
            <div class="col-md-4 col-sm-12 col-xs-12">
                <div class="links_footer">
                    <h3 class="title_footer">	{{ app()->getLocale() == 'ar' ? $org->name : $org->name_en}} Pages </h3>
                    <ul>
            ...
            <div class="col-md-4 col-xs-12">
                <div class="info_footer">
                    ...
                    <a href="tel:0220187656" class="phone_footer"><i class="fas fa-phone"></i> {{  $org->phone }} </a>
                    <a href="mailto:{{$org_id->email_crm}}" class="email_footer"> <i class="fas fa-envelope"></i> {{  $org->email_crm }}</a>
                    <p class="adress">
                      {{  $org_id->address }}
                    </p>
        ...
        <div class="last_footer">
            <div class="row">
                <div class="col-md-6 col-xs-12">
                    ...
                    <a href="#home"> {{ app()->getLocale() == 'ar' ? $org->name : $org->name_en}} </a>  <p class="buy_f"> © 2019 @lang('strings.front_text5') <a href="http://www.filerole.com/" target="_blank">@lang('strings.fileRole')</a>  </p>
                    </p>
