...
@section('content')
                ...
                <div class="row">
                    ...
                    <div class="col-sm-12 col-md-6 col-lg-6">
                        <div class="subheader-titles">
                            <h2 class="subheader-maintitle">
                              @lang('strings.payment_cancelled')
                            </h2>
                    ...
                    <div class="col-sm-12 col-md-6 col-lg-6">
                        <ul class="breadcrumbs fixclear">
                            ...
                            <li>@lang('strings.payment_cancelled')</li>
                        </ul>
    ...
    <div class="welcome-you wow flipInX">
        ...
        {{-- <h3>مرحباً <span>بك</span></h3> --}}
    {{-- <h6>{{__('strings.regardingto')}} {{__('strings.invoice_no')}}<span></span></h6> --}}
        <p>{{__('strings.payment_cancel_message')}} {{$error}} </p>
    </div>
