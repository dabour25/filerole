                   ...
                   <div class="slider-text">
                       ...
                       <div class="box-text wow fadeInDown" data-wow-delay="0.50s">            
                           <div class="inner_box">
                               ...
                               <p class="price wow fadeIn" data-wow-delay="0.5s">{{$offer->offer_price}}</p>
                               <p class="old_price wow fadeIn" data-wow-delay="0.5s">{{$offer->final_price}}</p>
                                  @if($show_cart)
                    ...
                    <div class="col-md-3 col-sm-6 col-xs-6">
                     <div class="item_pro wow fadeIn" data-wow-delay="0.20s">
                       ...
                       <div class="price_add">
                             ...
                             <h6>{{  $last_prodct->price->offer_price}}</h6>
                             <h6 class="old_price wow fadeIn">{{$last_prodct->final_price->final_price}}</h6>
                              @if($show_cart)
                             ...
                             <h6>{{ $last_prodct->price->final_price}}</h6>
                              @if($show_cart)
                    ...
                    <div class="item">
                        <div class="item_pro wow fadeIn" data-wow-delay="0.20s">
                           ...
                           @if($best_seler->offer_price)
                            <div class="price_add">
                                <h6>{{ $best_seler->final_price}}</h6>
                                <h6>{{ $best_seler->offer_price}}</h6>
                                   @if($show_cart)
