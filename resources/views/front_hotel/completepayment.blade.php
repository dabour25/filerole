...
@section('content')
                ...
                <div class="row">
                    ...
                    <div class="col-sm-12 col-md-6 col-lg-6">
                        <ul class="breadcrumbs fixclear">
                            ...
                            <li>@lang('strings.complete_payment')</li>
                        </ul>
    ...
    <h6>{{__('strings.regardingto')}} <span>{{$invoice_code}}</span></h6>
        <p>{{__('strings.payment_success_message')}} </p>
