@extends('layouts.admin', ['title' =>__('strings.facilities')])
        ...
        <div class="row">
            <div class="col-md-12">
                @include('alerts.index')
                         ...
                         <p>
                      @if (app()->getLocale() == 'ar')
           {{ DB::table('function_new')->where('id',236)->value('description') }}
           @else
           {{ DB::table('function_new')->where('id',236)->value('description_en') }}
           @endif
                         </p>
                  ...
                  <button type="button"  class="btn btn-info btn-lg NewBtn btnclient" data-toggle="modal" data-target="#addclient_machines">اضافة اثاث </button>
                    ...
                    <ul class="nav nav-pills" role="tablist">
                        <li role="presentation"  class="active" ><a href="#furniture" role="tab" data-toggle="tab"><i class="icon-basket"></i>&nbsp;&nbsp;@lang('strings.Machines')  </a></li>
                                  ...
                                  <table id="xtreme-table" class="display table" style="width: 100%; cellspacing: 0;">
                                      ...
                                      <tbody>
                                       @foreach($categories as $value)
                                          ...
                                          <td><img src="{{ $value->photo_id !== null ? asset(str_replace( ' ', '%20',$value->photo->file)) : asset('images/profile-placeholder.png') }}" width="40" height="40">
                                          </td>
                                              <td>
                                                  @if($value->active)
                                        ...
                                        <tbody>
                                         ...
                                         @foreach($cat_type_id->categories as $value)
                                            ...
                                            <td>{{ app()->getLocale() == 'ar' ?  $value->name :$value->name_en }}</td>
                                                ...
                                                <td>
                                  <a href="edit_category/{{ $value->id }}" class="btn btn-primary btn-xs" data-toggle="tooltip" data-placement="bottom" title=""  data-original-title="{{ __('strings.edit') }} "> <i  class="fa fa-pencil"></i></a>
                                  <a href="delete_facility/{{$value->id}}" class="btn btn-danger btn-xs" data-toggle="tooltip" data-placement="bottom" title="" data-original-title="{{ __('strings.delete_btn') }}"> <i class="fa fa-trash-o"></i></a>
                                                </td>
                                            </tr>
                                              @endforeach
                                              @endif
                                        ...
                                        <tbody>
                                          ...
                                          @foreach($cat_type_id->categories as $value2)
                                            <tr>
                                                ...
                                                <td><img src="{{ $value2->photo_id !== null ? asset(str_replace( ' ', '%20',$value2->photo->file)) : asset('images/profile-placeholder.png') }}" width="40" height="40">
                                                 </td>
                                                <td>
                                                    @if($value2->active)
                                                        <span class="label label-success" style="font-size:12px;">@lang('strings.Active')</span>
