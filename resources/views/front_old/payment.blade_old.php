...
.kl-bottommask--mask6 {
  ...
  $( document ).ready(function() {
    ...
    function show3(){
        ...
        document.getElementById('paypersonal').style.display ='block';
        var forms = document.querySelectorAll('.validate');
      for (var i = 0; i < forms.length; i++) {
      forms[i].removeAttribute("novalidate");
    }
    $("#name1").removeAttr('required');
...
if($('#cash_clicked').is(":checked"))
  show4();
else if($('#credit_clicked').is(":checked"))
  show1();
  ...
  $("#securitycode").removeAttr('required');
    ...
    $("#securitycode").removeAttr('required');
      ...
      function show4(){
        document.getElementById('payinfo').style.display = 'none';
        document.getElementById('paypersonal').style.display ='none';


    var forms = document.querySelectorAll('.validate');
for (var i = 0; i < forms.length; i++) {
forms[i].setAttribute('novalidate', false);
}
      };
