...
<head>
	...
	<meta name="keywords" content="filerole, programs, startup" />
	 ...
	 <meta name="auth" content="{{Auth::guard('customers')->check()?1:0}}">
...
@endphp
      ...
      <ul class="dropdown-menu">
            ...
            <li ><a href="{{ url('/customerdashboard') }}">  @lang('strings.cust_invoices') </a></li>
              <li ><a href="{{ url('/CustomerReservations') }}">  @lang('strings.reservation') </a></li>
...
data-toggle="modal" data-target="#cart">Cart (<span class="total-count"></span>)</button>-->
             ...
             <ul class="dropdown-menu">
                 ...
                 <div class="buttons-cart">
                         <a href="{{url('/cart')}}"  onclick="login_customer(event)" class="view_cart"> View Cart </a>
