        ...
        <div class="row">
            <div class="col-md-12">
                 <div class="alert_new">
                          ...
                          <p>
                              @if (app()->getLocale() == 'ar')
            {{ DB::table('function_new')->where('id',77)->value('description') }}
            @else
            {{ DB::table('function_new')->where('id',77)->value('description_en') }}
            @endif
                          </p>
                ...
                <ul class="nav nav-tabs">
                    @if(permissions('weekly_vacations_view') == 1)
                    ...
                    @if(permissions('yearly_vacations_view') == 1)
                ...
                <div class="tab-content">
                    <div id="weekly_vacations" class="tab-pane fade @if(Request::is('admin/weekly_vacations')) in active @endif ">
                        @if(permissions('weekly_vacations_add') == 1)
                    ...
                    <div id="yearly_vacations" class="tab-pane fade @if(Request::is('admin/yearly_vacations')) in active @endif">
                        @if(permissions('yearly_vacations_add') == 1)
