                    ...
                    <ul class="nav navbar-nav navbar-right">
                        <li class="dropdown">
                            <a class="dropdown-toggle waves-effect waves-button waves-classic" data-toggle="dropdown">
                                <span class="user-name">{{ Auth::user()->name }} {{ Auth::user()->name }}<i class="fa fa-angle-down"></i></span>
                    ...
                    <a href="{{ route('users.edit', Auth::user()->id) }}">
                        <div class="sidebar-profile-image">
                            <img src="{{ Auth::user()->photo ? asset(Auth::user()->photo->file) : asset('images/profile-placeholder.png') }}"
                                 class="img-circle img-responsive" alt="{{ Auth::user()->name }} {{ Auth::user()->name }}">
                        </div>
                        <div class="sidebar-profile-details">
                            <span>{{ Auth::user()->name }} {{ Auth::user()->name }}<br><small>{{ ucfirst(Auth::user()->role->name) }}</small></span>
                        </div>
                    </a>
                </div>
            </div>
...
@if(config('settings.freshchat_widget')!=NULL)
    ...
    <script>
        ...
        @if(Auth::user())
            ...
            window.fcWidget.user.setLastName("{{ Auth::user()->name }}");
