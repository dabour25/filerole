        ...
        <button type="button"  onclick="add_des()" class="btn btn-primary btn-lg NewBtn btnclient" data-toggle="modal" data-target="#addclient_destination">@lang('strings.create_destinations')</button>
                    ...
                    <div class="panel panel-white">
                        ...
                        <div class="panel-body">
                            ...
                            <button type="button"  id="modal_button" onclick="get_des({{$value->id}})"  class="btn btn-info btn-lg NewBtn btnclient" data-toggle="modal" data-target="#addclient"><i class="fas fa-plus"></i></button>
...
<script>
 function modal_show(id){
  console.log($('#modal_button'+id).data());
         ...
         $.each(d, function (key, item) {
          ...
          var des_newStr_en = item.description.replace(/  +/g, ' ');
           ...
           var name_en_newStr = name_newStr_en.split(' ').join('');
             ...
             '  <a href="delete_location/'+item.id+'" class="btn btn-danger btn-xs" data-toggle="tooltip" data-placement="bottom" title="" data-original-title="{{ __('strings.delete_btn') }}"> <i class="fa fa-trash-o"></i></a>                                                  ' +
             '                                                        ' +
             '                                                  ' +
